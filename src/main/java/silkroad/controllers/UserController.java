...
public class UserController {
    ...
    /* Get User's Purchases End-Point */
    @CrossOrigin(origins = "*")
    ...
    /* Delete Message access End-Point */
    @CrossOrigin(origins = "*")
